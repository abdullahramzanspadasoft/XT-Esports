...
import market from "@/public/Image/MarketPlace/marketplace-product-thumb-02.png";
...
import marketPlaceViewContent from "@/constant/home/market_place_view.json";
      ...
      <div className="w-full relative bg-[#010D18] overflow-hidden min-h-screen -mt-30 md:-mt-50 pt-0 pb-[60px] md:pb-[112px]">
        ...
        <section className="relative z-10 container mx-auto px-4 sm:px-6 md:px-8">
          <div className="mt-0 mb-7 md:mb-10">
            <h2 className="font-['Poppins'] flex flex-wrap items-baseline gap-x-3 gap-y-0 mt-[100px] text-[26px] sm:text-[38px] md:text-[66px] lg:text-[82px] leading-tight text-white font-bold">
              {marketPlaceViewContent.titlePrimary}{" "}
              <span className="font-light text-[#0185EB]">
                {marketPlaceViewContent.titleSecondary}
              </span>
            </h2>
          </div>
                  ...
                  <div className="flex items-end justify-between mt-auto pb-4 sm:pb-6 gap-3">
                    <p
                      ...
                      style={{
                        fontFamily: "Poppins",
                        fontWeight: 500,
                        fontSize: "clamp(11px, 1vw, 12.21px)",
                        lineHeight: "16px",
                        color: "#036CB9",
                        whiteSpace: "pre-wrap",
                    ...
                    >
                      {product.description ||
                        marketPlaceViewContent.fallbackDescription}
                    </p>
                    ...
                    <button
                      ...
                      aria-label={marketPlaceViewContent.addToCartLabel}
                    >
                      <PlusIcon />
                    </button>
                  </div>
