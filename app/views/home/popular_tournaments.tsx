...
const PopularTournaments = () => {
  ...
  const desktopCardStep = desktopCardWidth + CARD_GAP;
  const desktopViewportWidth =
    VISIBLE_COUNT * desktopCardWidth + (VISIBLE_COUNT - 1) * CARD_GAP;
  const desktopCardHeight = desktopCardWidth * (620.85 / 365.68);
  const desktopBadgeSize = desktopCardWidth * (93.8 / 365.68);
  ...
  const translateX = -currentIndex * desktopCardStep;
              ...
              >
                ...
                >
                  {mobileCloned.map((tournament, i) => (
                    <div
                      key={i}
                      style={{ width: `${MOBILE_CARD_WIDTH}px`, flexShrink: 0 }}
                    ...
                    >
                      ...
                      <div className="mt-3 text-center">
                        ...
                        <p className="text-[12px] mt-1 text-white opacity-80">
                          {tournament.name}
                        </p>
                      </div>
                    </div>
                  ...
                  {laptopCloned.map((tournament, i) => (
                    ...
                    >
                      ...
                      <div className="mt-4 text-center">
                        ...
                        <p className="text-[13px] text-white opacity-80 mt-1">
                          {tournament.name}
                        </p>
                      </div>
                    </div>
              ...
              >
                {cloned.map((tournament, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      style={{ width: `${desktopCardWidth}px`, flexShrink: 0 }}
                      className="group relative flex flex-col items-center hover:z-50"
                    >
                      <div
                        className="absolute -top-[46.9px] left-1/2 -translate-x-1/2 z-30"
                        style={{
                          width: `${desktopBadgeSize}px`,
                          height: `${desktopBadgeSize}px`,
                        }}
                      >
                        <Image
                          src={ellipseImages[i % 4]}
                      ...
                      <div
                        className="transition-all duration-500 ease-in-out group-hover:scale-110 cursor-pointer"
                        style={{
                      ...
                      <div className="mt-[15.9px] text-center">
                        <h3 className="font-bold text-[22px] lg:text-[28px] text-white whitespace-nowrap">
                          {tournament.name}
                        </h3>
                        <p className="text-[14px] mt-2 text-white whitespace-nowrap opacity-80">
                          {tournament.name}
                        </p>
                      </div>
                    </div>
